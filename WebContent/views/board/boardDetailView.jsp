...
<body>
    ...
    <div class="outer">
            ...
            <tr>
                ...
                <td colspan="3">
                	<% if(at == null) { %>
                    	...
                    	첨부파일이 없습니다.
               		<% } else { %>
                    	<!-- 브라우저에서 http://localhost:8888/jsp/resources/board_upfiles/2021091220125379152.jpg 검색 시 이미지 보임 -->
                    	<!-- 첨부파일이 있을 경우 -->
        ...
        <!-- 우선 화면구현 먼저만 하자. 기능구현은 AJAX 배우고나서 할것 -->
        <div id="reply-area">
                ...
                <thead>
                    ...
                    <% } else { %>
	                    ...
	                    <tr>
	                        <th>댓글작성</th>
	                        <td>
	                            <textarea cols="50" rows="3" style="resize:none" readonly>로그인 후 이용 가능한 서비스 입니다.</textarea>
	                        </td>
            	...
            	function insertReply(){
            		$.ajax({
            			...
            			data : {
            				...
            				bno : <%= b.getBoardNo() %>
            				// 현재 로그인한 회원이 없다면 NullPointerException 이 발생할 수 있으므로 
            				// 화면에서 로그인한 회원의 정보를 넘기지는 않을것임
            			},
            			type : "post",
